export default {
    ...
    panda: {
        navColor: 'grey darken-4',
        background: 'grey darken-2',
        titleText1: 'light-blue-text text-lighten-4',
        titleText2: 'pink-text text-lighten-3',
        text1: 'white-text',
        text2: 'cyan-text text-lighten-2',
    ...
    monokai: {
        ...
        text1: 'white-text',
        text2: 'orange-text text-darken-1',
        button: 'light-blue lighten-2',
        buttonText: 'yellow-text text-lighten-2',
        current: 'monokai',
    },
    soldark: {
        navColor: 'light-blue darken-3',
        background: 'light-blue darken-4',
        titleText1: 'light-green-text text-darken-2',
        titleText2: 'light-green-text text-darken-2',
        text1: 'white-text',
        text2: 'cyan-text text-lighten-1',
    ...
    quietlight: {
        ...
        titleText1: 'red-text text-darken-4',
        titleText2: 'blue-text text-lighten-1',
        text1: 'black-text',
        text2: 'purple-text',
    ...
    sublime: {
        ...
        titleText1: 'blue-text text-lighten-3',
